  ...
  return (
    <div className="card">
      <div className="card-body">
        <p>
          <h4>What is Lorem Ipsum?</h4> Lorem Ipsum is simply dummy text of the
        ...
        <p>
          <h4>Why do we use it?</h4> It is a long established fact that a reader
        ...
        <p>
          <h4>Where does it come from?</h4>Contrary to popular belief, Lorem
        ...
        <p>
          <h4>Where can I get some?</h4> There are many variations of passages
